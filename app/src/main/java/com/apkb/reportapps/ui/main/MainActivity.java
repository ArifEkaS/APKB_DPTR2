...
public class MainActivity extends AppCompatActivity {
    ...
    CardView cvKerusakan, cvStatusLaporan, cvRiwayatLaporan;
    ...
    private void setInitLayout() {
        cvKerusakan = findViewById(R.id.cvKerusakan);
        cvStatusLaporan = findViewById(R.id.cvStatusLaporan);;
        cvRiwayatLaporan = findViewById(R.id.cvRiwayatLaporan);

        cvKerusakan.setOnClickListener(v -> {
            strTitle = "Laporan Kerusakan barang";
